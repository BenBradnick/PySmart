...
class CreateNewWebhookDevice(unittest.TestCase):
    ...
    def test_on_webhook_path_cannot_be_none(self):
        ...
        self.assertRaises(ValueError, WebhookDevice, name, on_webhook_path,
    ...
    def test_creating_device_with_valid_params_does_not_raise_ValueError(self):
        ...
        try:
            WebhookDevice(name, on_webhook_path, off_webhook_path,
                          url_manager)
        except ValueError:
...
class SwitchingDeviceState(unittest.TestCase):
    ...
    def test_turning_on_device_changes_state_to_on_when_http_status_ok(self):
        ...
        device = WebhookDevice(name, on_webhook_path, off_webhook_path, url_manager)
